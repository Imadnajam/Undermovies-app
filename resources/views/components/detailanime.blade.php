    ...
    <header class="header" data-header>
      <div class="container">
        ...
        <a href="{{route('home')}}" class="logo">
          <img src="{{asset('image/series/logo.png')}}" width="100px" alt="animelane logo">
        </a>
            ...
            <div class="movie-detail-content">
              ...
              <div class="meta-wrapper">
                ...
                <div class="badge-wrapper">
                  <div class="badge badge-fill">{{$anime['Status']}}</div>
  
                  <div class="badge badge-outline">HD</div>
                </div>
  
                <div class="ganre-wrapper">
                    <a href="#">{{ implode(', ', $anime['Genre']) }}</a>
              ...
              <a href="{{ $anime['ImageURL'] }}" download class="download-btn">
                <span>Download</span>
        ...
        <div class="container">
          ...
          <div class="footer-brand-wrapper">
            ...
            <ul class="footer-list">
              ...
              <li>
                <a href="{{route('anime')}}" class="footer-link">Anime</a>
              </li>
