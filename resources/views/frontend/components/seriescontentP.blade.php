...
<main>
    ...
    <nav class="menu">
        <div class="menu__item">
            ...
            <span class="menu__item-textwrap"><span class="menu__item-text">{{__('series.AA')}} </span></span>
            <a class="menu__item-link">{{__('series.explore')}}</a>
        </div>
        <div class="menu__item">
            <span class="menu__item-number">02</span>
            <span class="menu__item-textwrap"><span class="menu__item-text">{{__('series.Comedy')}}</span></span>
            <a class="menu__item-link">{{__('series.explore')}}</a>
        </div>
        <div class="menu__item">
            <span class="menu__item-number">03</span>
            <span class="menu__item-textwrap"><span class="menu__item-text">{{__('series.SFF')}}
                </span></span>
            <a class="menu__item-link">{{__('series.explore')}}</a>
        </div>
        <div class="menu__item">
            <span class="menu__item-number">04</span>
            <span class="menu__item-textwrap"><span class="menu__item-text">{{__('series.Horror')}}</span></span>
            <a class="menu__item-link">{{__('series.explore')}}</a>
        </div>
        <div class="menu__item">
            <span class="menu__item-number">05</span>
            <span class="menu__item-textwrap"><span class="menu__item-text">{{__('series.CM')}}
                </span></span>
            <a class="menu__item-link">{{__('series.explore')}}</a>
        </div>
    </nav>
