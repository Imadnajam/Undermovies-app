    ...
    <div class="container">
      <div class="wrap">
        ...
        <div class="fix-7-12">
          ...
          <img width="100px" src="{{asset('image/series/logo.png')}}" alt="Filmlane logo">
        </div>  
        
      </div>
    </div>
  </div>
  <div class="background" style="background-image:url({{asset('image/about/img/background/img-10.jpg')}})"></div>
</section>
...
<section class="slide fade-6 kenBurns">
        ...
        <div class="fix-12-12">
          <ul class="grid grid-75 masonry fixedSpaces ae-3 controller popupTrigger" data-popup-id="75-1" data-slider-id="75-1">
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-6 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-7.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-3 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-6.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="c{{asset('image/about/img/gallery-75-5.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-7 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-1.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-9 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-3.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-5 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-4.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
            <li class="col-3-12 col-tablet-1-3 col-phablet-1-2 col-phone-1-1 ae-4 fadeIn">
              <img src="{{asset('image/about/img/gallery-75-2.jpeg')}}" class="wide rounded margin-bottom-1" alt="Image"/>
            </li>
          </ul>
        </div>
  ...
  <div class="background" style="background-image:url({{asset('image/about/img/gallery-75.png')}})"></div>
</section>
    ...
    <div class="container">
      <div class="wrap spaces">
        ...
        <ul class="slider animated ae-1 fromAbove inlineBlock clickable popupContent disableSelect" data-slider-id="75-1" style="display: inline-block;">
          <li class="selected">
            <img src="{{asset('image/about/img/gallery-75-7.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-6.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-5.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-1.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-3.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-4.jpeg')}}" class="rounded" alt="Image"/>
          </li>
          <li>
            <img src="{{asset('image/about/img/gallery-75-2.jpeg')}}" class="rounded" alt="Image"/>
          </li>
        </ul>
...
<section class="slide fade-6 kenBurns">
        ...
        <div class="fix-12-12 margin-top-3">
          <ul class="flex fixedSpaces later left">
            <li class="col-3-12 col-tablet-1-2 col-phone-1-1">
              <div class="button rounded empty margin-bottom-2 videoThumbnail noShadow popupTrigger ae-3" data-popup-id="90-2"><img class="wide" src="{{asset('image/about/img/gallery-90-1.jpeg')}}" alt="Video Thumbnail"/></div>
            ...
            <li class="col-3-12 col-tablet-1-2 col-phone-1-1">
              <a href="#" class="button rounded empty margin-bottom-2 ae-4"><img class="wide" src="{{asset('image/about/img/gallery-90-2.jpeg')}}" alt="Image Thumbnail"/></a>
              <h3 class="ae-5">Creativity</h3>
              <div class="ae-6"><p class="tiny opacity-6">You don’t have to be “a creative” to be creative.</p></div>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phone-1-1">
              <a href="#" class="button rounded empty margin-bottom-2 ae-5"><img class="wide" src="{{asset('image/about/img/gallery-90-3.jpeg')}}" alt="Image Thumbnail"/></a>
              <h3 class="ae-6">Fashion</h3>
              <div class="ae-7"><p class="tiny opacity-6">There is no such thing as simple. Simple is hard.</p></div>
            </li>
            <li class="col-3-12 col-tablet-1-2 col-phone-1-1">
              <a href="#" class="button rounded empty margin-bottom-2 ae-6"><img class="wide" src="{{asset('image/about/img/gallery-90-4.jpeg')}}" alt="Image Thumbnail"/></a>
  ...
  <div class="background" style="background-image:url({{asset('image/about/img/img-90.png')}})"></div>
</section>
...
<section class="slide fade-6 kenBurns">
        ...
        <div class="fix-12-12">  
          <ul class="grid grid-74 later equal margin-top-5">
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-3 fromCenter">
              <a href="#" class="box-74">
                <div class="thumbnail-74">
                  <img src="{{asset('image/about/img/gallery-74-1.jpeg')}}" class="wide" alt="Thumbnail"/>
                </div>
            ...
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-4 fromCenter">
              <a href="#" class="box-74">
                <div class="thumbnail-74">
                  <img src="{{asset('image/about/img/gallery-74-2.jpeg')}}" class="wide" alt="Thumbnail"/>
                </div>
                <div class="name-74 equalElement table wide">
                  <div class="cell left top">
            ...
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-5 fromCenter">
              <a href="#" class="box-74">
                <div class="thumbnail-74">
                  <img src="{{asset('image/about/img/gallery-74-3.jpeg')}}" class="wide" alt="Thumbnail"/>
                </div>
                <div class="name-74 equalElement table wide">
                  <div class="cell left top">
                    <h3 class="">Journey</h3>
            ...
            <li class="col-3-12 col-tablet-1-2 col-phablet-1-1 ae-5 fromCenter">
              <a href="#" class="box-74">
                <div class="thumbnail-74">
                  <img src="{{asset('image/about/img/gallery-74-4.jpeg')}}" class="wide" alt="Thumbnail"/>
                </div>
                <div class="name-74 equalElement table wide">
                  <div class="cell left top">
  ...
  <div class="background" style="background-image:url({{asset('image/about/img/img-74.png')}})"></div>
</section>
...
<section class="slide fade-6 kenBurns">
          ...
          <ul class="grid equal fixedSpaces margin-top-3">
            <li class="col-4-12 ae-3">
              <div class="fix-3-12 equalElement">
                ...
                <p class="tiny"><a class="opacity-8" href="#"> Allen Street, Casablanca, ste. 706, 11249</a></p>
              </div>
              <div class="fix-3-12 equalElement">
                <h6 class="uppercase opacity-4 margin-top-3 margin-bottom-2">Casablanca Studio</h6>
                <p class="tiny"><a class="opacity-8" href="#">312 ISGI</a></p>
              </div>
            </li>
            <li class="col-4-12 ae-4">
              <div class="fix-3-12 equalElement">
                <h6 class="uppercase opacity-4 margin-top-3 margin-bottom-2">Generatal Engquires</h6>
                <p class="tiny"><a class="opacity-8" href="mailto:#">UnderMovie@gmail.com</a></p>
              </div>
              <div class="fix-3-12 equalElement">
              ...
              <div class="fix-3-12 equalElement">
                <h6 class="uppercase opacity-4 margin-top-3 margin-bottom-2">NJ</h6>
                <p class="tiny"><a class="opacity-8" href="mailto:#">UnderMovie@gmail.com</a></p>
              </div>
            </li>
  ...
  <div class="background" style="background-image:url({{asset('image/about/img/img-56.jpeg')}})"></div>
</section>
